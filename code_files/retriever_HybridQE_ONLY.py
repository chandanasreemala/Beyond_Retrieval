...
class SemanticRetriever:  
    def __init__(self, texts):    
        ...
        ## Dimension of the embeddings for sentence transformers of this model is 768. 
        ## That means each sentence or document will be represented as a dense vector of length 768 
...
class HybridRetriever:
    ...
    def expand_query(self, query: str, max_synonyms: int = 2) -> str:
        """Expands query using WordNet synonyms with a limit on the number of synonyms."""
        expanded_terms = set()
        for word in query.split():
            ...
            # Add only the top `max_synonyms` synonyms
    ...
    def enhanced_reciprocal_rank_fusion(
        ...
        """Combines rankings from multiple retrievers without weights."""
        scores = {}
        for rank_list in rankings:
            for rank, doc in enumerate(rank_list):
                if doc not in scores:
                    scores[doc] = 0
                scores[doc] += 1 / (rank + k)  # No weights, equal contribution from all retrievers
        return scores
    ...
    def get_relevant_documents(self, query: str, k: int = 3) -> List[str]:
        ...
        # Combine rankings without weights
...
def main():
	...
	cleaned_rows.to_csv('retriever_results_QE.csv', index=False)
	return cleaned_rows
...
# Modified Results of this code is "retriever_results_HybridQE_final.csv"
# Raw/original Results of this code is "retriever_results_HybridQE_original.csv"

'''
Average of sparse_ap: 0.7242494170813201
Average of sparse_ndcg: 0.7325226666937964
Average of dense_ap: 0.7681786495516933
Average of dense_ndcg: 0.782175280414898
Average of hybrid_ap_only_QE: 0.7891116071243849
Average of hybrid_ndcg_only_QE: 0.8129311932921216
