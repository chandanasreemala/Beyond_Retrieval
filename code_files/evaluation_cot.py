...
df_halueval = pd.read_excel('halueval_cot_annotated.xlsx')
df_drop = pd.read_excel('drop_cot_annotated.xlsx')
df_covid = pd.read_excel('covid_cot_annotated.xlsx')
df_finance = pd.read_excel('financebench_cot_annotated.xlsx')
df_ragtruth = pd.read_excel('ragtruth_cot_annotated.xlsx')
df_pubmed = pd.read_excel('pubmedqa_cot_annotated.xlsx')
...
# Evaluate metrics
results = evaluate_hallucinated_samples(df_combined)
